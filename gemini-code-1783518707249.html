...
<head>
    ...
    <style>
        ...
        * {
        ...
        .hero {
            /* Updated background image link featuring African American skilled trades professionals */
...
<body>
        ...
        <div class="grid-2">
            ...
            <div class="card">
                ...
                <ul>
                    ...
                    <li><span>Location</span> <strong>South Carolina, USA</strong></li>
    ...
    <footer>
        <p><strong>Inclusive Sovereignty Inc.</strong><br>Moncks Corner, South Carolina 29461</p>
